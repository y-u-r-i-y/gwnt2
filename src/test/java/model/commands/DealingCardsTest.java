...
public class DealingCardsTest extends BaseJsonMappingTest {
    ...
    public void testDealOneCard() throws Exception {
        Card card = new Card("Geralt", CardType.CLOSE, DeckType.NEUTRAL, true, false, "the grey one");
    ...
    public void testDealThreeCards() throws Exception {
        Card card1 = new Card("Geralt", CardType.CLOSE, DeckType.NEUTRAL, true, false, "the grey one");
        Card card2 = new Card("Yen", CardType.RANGED, DeckType.NEUTRAL, true, false, "hot and annoying");
        Card card3 = new Card("Infantry", CardType.CLOSE, DeckType.NORTHERN, false, false, "poor f_cking infantry");
